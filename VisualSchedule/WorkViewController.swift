...
protocol TableViewCellDelegate11 {
    // indicates that the given item has been deleted
}

class tableViewCell11: UITableViewCell, UITextFieldDelegate {
...
class WorkViewController: UIViewController, UISearchBarDelegate, UITableViewDelegate, UIImagePickerControllerDelegate, UITextFieldDelegate, UINavigationControllerDelegate  {
    ...
    override func viewDidLoad() {
        ...
        let cell = self.tableView.dequeueReusableCellWithIdentifier("Cell") as tableViewCell11
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = self.tableView.dequeueReusableCellWithIdentifier("Cell", forIndexPath: indexPath) as tableViewCell11
